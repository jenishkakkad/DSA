...
int main() {
    ...
    cout<<"1 st node Address:"<<HEAD->next<<endl;
    cout<<"-------------------------------"<<endl;
    ...
    cout<<"2 d node Address:"<<HEAD->next->next<<endl;
    cout<<"-------------------------------"<<endl;
    ...
    cout<<"3 d node Address:"<<HEAD->next->next->next<<endl;
    cout<<"-------------------------------"<<endl;
    ...
    cout<<"4 th node Address:"<<HEAD->next->next->next->next<<endl;
    cout<<"-------------------------------"<<endl;
