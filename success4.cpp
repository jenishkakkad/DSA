...
int main() {
    ...
    cout << "2nd node Address: " << Newnode->next << endl;
    cout << "-------------------------------" << endl;

    cout << "2nd node Data: " << Newnode->data << endl;
    cout << "3rd node Address: " << Newnode->next << endl;
    cout << "-------------------------------" << endl;

    cout << "3rd node Data: " << Newnode->data << endl;
    cout << "4th node Address: " << Newnode->next << endl;
    cout << "-------------------------------" << endl;

    cout << "4th node Data: " << Newnode->data << endl;
    cout << "5th node Address: " << Newnode->next << endl;
    cout << "-------------------------------" << endl;
